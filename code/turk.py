...
vague_lack_definition_file = '../data/vague_terms_lack_definition'
vague_sents_csv = '../data/vague_sentences_groups_of_5.csv'
...
with open(vague_sents_doc_file, 'w') as f:
    for item in vague_sents_doc:
        f.write("%s\n" % item)
