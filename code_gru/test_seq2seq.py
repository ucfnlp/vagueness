...
y_train_onehot = np.zeros((y_train.shape, vocab_size))
for i in range(len(y_train)):
    y_train_onehot[i, numpy.arange(len(y_train[i])), y_train[i]] = 1
...
model.add(SimpleSeq2Seq(input_dim=embedding_dim, hidden_dim=100, 
                        output_length=maxlen, output_dim=vocab_size))
