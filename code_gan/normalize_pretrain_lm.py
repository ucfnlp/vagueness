...
model_file = '../models/tf_normalize_lm_model'
variables_file = '../models/tf_normalize_lm_variables.npz'
dataset_file = '../data/dataset.h5'
ckpt_dir = '../models/normalize_lm_ckpts'
fast = False
...
squared = logits*logits*logits
# summation = tf.reduce_sum(squared, -1)
# normalized = squared / summation
logits = tf.reshape(squared, [-1, FLAGS.SEQUENCE_LEN, FLAGS.VOCAB_SIZE])
