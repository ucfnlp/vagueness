...
GEN_EMBEDDING = 'G_/' + TEST_EMBEDDING
...
DISC_EMBEDDING = 'D_/embedding/kernel:0'
...
class GAN_PARAMS:
	EMBEDDING = (TRAIN_EMBEDDING, GEN_EMBEDDING)
	...
	D_EMBEDDING = (TRAIN_EMBEDDING, DISC_EMBEDDING)

	VARIABLE_PAIRS = [EMBEDDING, GRU_GATES_WEIGHTS, GRU_GATES_BIASES, GRU_CANDIDATE_WEIGHTS, 
						GRU_CANDIDATE_BIASES, OUTPUT_WEIGHTS, OUTPUT_BIASES, D_EMBEDDING]