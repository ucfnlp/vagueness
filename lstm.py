...
# test_Y_padded_vague = test_Y_padded_vague.reshape((test_Y_padded_vague.shape[0], test_Y_padded_vague.shape[1]))
# Y_predict, Y_vague_predict = model.predict_generator(
